...
export const GOMI_ITEMS: GomiItem[] = [
  // もえるゴミ
  { id: "food_waste", emoji: "🍚", nameJa: "生ゴミ", nameVi: "Rác thức ăn thừa", categoryId: "moeru", note: "Nên để ráo nước trước khi cho vào túi." },
  { id: "clothes", emoji: "👕", nameJa: "古着", nameVi: "Quần áo cũ", categoryId: "moeru", note: "Quần áo và giày dép được xếp vào rác cháy được." },
  { id: "shoes", emoji: "👟", nameJa: "靴（運動靴）", nameVi: "Giày thể thao", categoryId: "moeru", note: "Cùng nhóm với quần áo cũ -- rác cháy được." },
  { id: "flowers", emoji: "💐", nameJa: "生花（枯れたもの）", nameVi: "Hoa tươi đã héo", categoryId: "moeru", note: "Thuộc nhóm \"đồ vật khác\" trong rác cháy được." },
  { id: "stuffed_toy", emoji: "🧸", nameJa: "ぬいぐるみ", nameVi: "Thú nhồi bông", categoryId: "moeru", note: "Đồ vải bông nhồi -- rác cháy được." },
  { id: "diaper", emoji: "🩲", nameJa: "使用済み紙おむつ", nameVi: "Tã giấy đã dùng", categoryId: "moeru", note: "Tã dùng một lần được nêu rõ trong bài học là rác cháy được." },
  { id: "rope", emoji: "🪢", nameJa: "紐・ロープ", nameVi: "Dây, thừng", categoryId: "moeru", note: "Dùng để buộc các loại rác khác, bản thân nó cũng là rác cháy được." },
  { id: "branches", emoji: "🌿", nameJa: "木の枝（束ねたもの）", nameVi: "Cành cây (đã bó lại)", categoryId: "moeru", note: "Cắt thành đoạn khoảng 50cm và buộc bằng dây trước khi vứt." },
  { id: "socks", emoji: "🧦", nameJa: "靴下（布製）", nameVi: "Tất/vớ vải", categoryId: "moeru", note: "Đồ vải -- cùng nhóm với quần áo cũ." },

  // もえないゴミ
  { id: "broken_bowl", emoji: "🍶", nameJa: "割れた茶碗", nameVi: "Bát sứ bị vỡ", categoryId: "moenai", note: "Đồ sứ/gốm vỡ thuộc rác không cháy được." },
  { id: "clock", emoji: "🕐", nameJa: "掛け時計", nameVi: "Đồng hồ treo tường", categoryId: "moenai", note: "Đồ vật nhỏ bằng nhựa/kim loại tổng hợp." },
  { id: "knife", emoji: "🔪", nameJa: "包丁・ハサミ", nameVi: "Dao, kéo", categoryId: "moenai", note: "Phải gói bằng giấy báo, ghi rõ \"nguy hiểm\" (危険) bên ngoài, KHÔNG bỏ chung túi với rác không cháy khác." },
  { id: "lightbulb", emoji: "💡", nameJa: "電球", nameVi: "Bóng đèn (loại thường)", categoryId: "moenai", note: "Thủy tinh + kim loại -- rác không cháy được." },
  { id: "plant_pot", emoji: "🪴", nameJa: "植木鉢（陶器）", nameVi: "Chậu cây bằng gốm sứ", categoryId: "moenai", note: "Đồ gốm sứ -- rác không cháy được." },
  { id: "fan", emoji: "🌀", nameJa: "扇風機", nameVi: "Quạt điện (loại nhỏ)", categoryId: "moenai", note: "Đồ điện nhỏ không thuộc luật tái chế gia dụng lớn." },
  { id: "vacuum", emoji: "🧹", nameJa: "掃除機", nameVi: "Máy hút bụi (loại nhỏ)", categoryId: "moenai", note: "Đồ điện nhỏ -- khác với tủ lạnh/máy giặt/điều hòa/tivi (大型家電)." },
  { id: "bike_tire", emoji: "🚲", nameJa: "自転車のタイヤ", nameVi: "Lốp xe đạp", categoryId: "moenai", note: "Cao su + kim loại -- rác không cháy được." },
  { id: "hanger", emoji: "👔", nameJa: "ハンガー（針金）", nameVi: "Móc áo bằng dây kẽm", categoryId: "moenai", note: "Kim loại nhỏ -- rác không cháy được." },
  { id: "kettle_small", emoji: "🫖", nameJa: "電気ポット", nameVi: "Bình đun nước điện (loại nhỏ)", categoryId: "moenai", note: "Đồ điện nhỏ -- rác không cháy được." },

  // 資源ゴミ
  { id: "can", emoji: "🥫", nameJa: "空き缶", nameVi: "Lon rỗng", categoryId: "shigen", note: "Rửa sạch trước khi vứt. Có thể tái chế thành lon mới, vành xe, vật liệu xây dựng." },
  { id: "glass_bottle", emoji: "🍾", nameJa: "空き瓶", nameVi: "Chai thủy tinh (còn nguyên)", categoryId: "shigen", note: "Chai vỡ thì xếp vào rác không cháy được, chai còn nguyên thì tái chế." },
  { id: "newspaper", emoji: "📰", nameJa: "新聞紙", nameVi: "Báo cũ", categoryId: "shigen", note: "Giấy sạch, khô ráo có thể tái chế thành báo/tạp chí mới." },
  { id: "magazine", emoji: "📖", nameJa: "雑誌", nameVi: "Tạp chí", categoryId: "shigen", note: "Có thể tái chế thành thùng các tông, sách ảnh." },
  { id: "cardboard", emoji: "📦", nameJa: "段ボール", nameVi: "Thùng các tông", categoryId: "shigen", note: "Buộc gọn bằng dây trước khi vứt." },
  { id: "milk_carton", emoji: "🥛", nameJa: "牛乳パック（洗って開いたもの）", nameVi: "Hộp sữa (đã rửa sạch, mở ra)", categoryId: "shigen", note: "Rửa và phơi khô, cắt mở ra -- tái chế thành khăn giấy/giấy vệ sinh." },
  { id: "pot_pan", emoji: "🍳", nameJa: "鍋・フライパン", nameVi: "Nồi, chảo cũ", categoryId: "shigen", note: "Đồ dùng chỉ làm từ kim loại được xếp vào rác tài nguyên." },
  { id: "food_tray", emoji: "🍱", nameJa: "食品トレー（洗ったもの）", nameVi: "Khay đựng thịt/cá (đã rửa)", categoryId: "shigen", note: "Nếu không rửa sạch được vết bẩn thì bỏ vào rác cháy được." },
  { id: "cookie_tin", emoji: "🥫", nameJa: "クッキー缶（金属）", nameVi: "Hộp bánh quy bằng kim loại", categoryId: "shigen", note: "Kim loại -- rác tài nguyên." },

  // プラスチックゴミ
  { id: "noodle_cup", emoji: "🍜", nameJa: "カップ麺の容器", nameVi: "Vỏ mì ly", categoryId: "plastic", note: "Rửa sạch trước khi vứt vào rác nhựa." },
  { id: "styrofoam", emoji: "📦", nameJa: "発泡スチロール", nameVi: "Xốp (styrofoam)", categoryId: "plastic", note: "Nhẹ và mỏng -- thường xếp vào rác nhựa." },
  { id: "plastic_dish", emoji: "🍽️", nameJa: "プラスチック食器", nameVi: "Bát đĩa nhựa", categoryId: "plastic", note: "Có dấu \"プラ\" thì xếp vào rác nhựa/tài nguyên." },
  { id: "shampoo_bottle", emoji: "🧴", nameJa: "シャンプーボトル", nameVi: "Chai dầu gội (rỗng)", categoryId: "plastic", note: "Rửa sạch trước khi vứt." },
  { id: "sauce_bottle", emoji: "🍶", nameJa: "ソース・マヨネーズ容器", nameVi: "Chai tương/sốt mayonnaise (rỗng)", categoryId: "plastic", note: "Rửa sạch trước khi vứt." },
  { id: "wash_basin", emoji: "🪣", nameJa: "洗面器（プラ製）", nameVi: "Chậu rửa mặt bằng nhựa", categoryId: "plastic", note: "Đồ nhựa dày hơn thẻ ngân hàng có thể xếp vào rác không cháy được tùy địa phương." },

  // PETボトル
  { id: "pet_bottle_water", emoji: "🍾", nameJa: "水のペットボトル", nameVi: "Chai nước PET", categoryId: "pet", note: "Tháo nắp, tháo nhãn, rửa sạch trước khi vứt." },
  { id: "pet_bottle_tea", emoji: "🧃", nameJa: "お茶のペットボトル", nameVi: "Chai trà PET", categoryId: "pet", note: "Cùng quy tắc: tháo nắp/nhãn, rửa sạch." },

  // 粗大ゴミ
  { id: "table", emoji: "🪑", nameJa: "木製テーブル", nameVi: "Bàn gỗ", categoryId: "sodai", note: "Đồ nội thất lớn, không vừa túi 20 lít." },
  { id: "chair", emoji: "🪑", nameJa: "椅子", nameVi: "Ghế", categoryId: "sodai", note: "Nếu tháo rời được thành mảnh nhỏ có thể vứt vào ngày rác cháy được." },
  ...
  { id: "futon", emoji: "🛌", nameJa: "掛布団", nameVi: "Chăn/đệm bông", categoryId: "sodai", note: "Đồ dùng giường chiếu -- rác cồng kềnh." },
  ...
  { id: "tatami", emoji: "🟫", nameJa: "畳", nameVi: "Chiếu tatami", categoryId: "sodai", note: "Kích thước lớn -- rác cồng kềnh." },
  { id: "desk", emoji: "🗄️", nameJa: "事務用デスク", nameVi: "Bàn làm việc", categoryId: "sodai", note: "Đồ nội thất lớn -- rác cồng kềnh." },

  // 大型家電
  { id: "fridge", emoji: "🧊", nameJa: "冷蔵庫", nameVi: "Tủ lạnh", categoryId: "kaden", note: "Thuộc luật tái chế đồ điện gia dụng -- không vứt như rác cồng kềnh." },
  { id: "washer", emoji: "🌀", nameJa: "洗濯機", nameVi: "Máy giặt", categoryId: "kaden", note: "Phải liên hệ cửa hàng hoặc đơn vị thu gom chỉ định (có phí)." },
  { id: "aircon", emoji: "❄️", nameJa: "エアコン", nameVi: "Máy điều hòa", categoryId: "kaden", note: "Không thể vứt vào ngày rác thường dù đã tháo rời." },
  { id: "tv", emoji: "📺", nameJa: "液晶テレビ", nameVi: "Tivi", categoryId: "kaden", note: "Thuộc 4 mặt hàng chính của luật tái chế gia dụng lớn." },

  // 危険・有害ゴミ
  { id: "battery", emoji: "🔋", nameJa: "乾電池", nameVi: "Pin khô", categoryId: "kiken", note: "Thu gom riêng theo lịch của địa phương." },
  { id: "spray_can", emoji: "🧴", nameJa: "スプレー缶", nameVi: "Bình xịt", categoryId: "kiken", note: "Phải xì hết ga (đâm thủng, làm xẹp) trước khi vứt vì có nguy cơ phát nổ." },
  { id: "fluorescent", emoji: "💡", nameJa: "蛍光灯", nameVi: "Đèn huỳnh quang", categoryId: "kiken", note: "Chứa hóa chất -- thu gom riêng, không cùng rác không cháy thường." },
  { id: "lighter", emoji: "🔥", nameJa: "ライター", nameVi: "Bật lửa", categoryId: "kiken", note: "Có nguy cơ cháy nổ -- xếp vào rác nguy hiểm." },
  { id: "thermometer", emoji: "🌡️", nameJa: "体温計", nameVi: "Nhiệt kế đã qua sử dụng", categoryId: "kiken", note: "Thu gom riêng theo lịch của địa phương." },
  ...
  { id: "mobile", emoji: "📱", nameJa: "携帯電話", nameVi: "Điện thoại di động cũ", categoryId: "special", note: "Được thu gom tại tòa thị chính hoặc cửa hàng điện thoại." },
];
